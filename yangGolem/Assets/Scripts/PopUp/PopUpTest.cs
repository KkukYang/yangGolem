    ...
    void Update()
    {
        ...
        if (Input.GetMouseButtonDown(0))
        {
            ...
            if (Physics.Raycast(ray, out hit, 100.0f, mask))
            {
                ...
                TileInfoManager.instance.curSelectObject.transform.eulerAngles = Vector3.zero;
                TileInfoManager.instance.curSelectObject.name = selectObject.name;
                TileInfoManager.instance.curSelectObject.layer = LayerMask.NameToLayer("SelectedObj");
